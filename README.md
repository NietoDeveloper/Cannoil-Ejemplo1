...
<p align="center">
  ...
  <a href="https://react.dev/">
    <img src="https://img.shields.io/badge/React-Front--End-61DAFB?style=for-the-badge&logo=react&logoColor=000"/>
  </a>
...
```mermaid
flowchart LR
    A([👤 Visitor]) -->|Loads App| B[main.jsx]
    B --> C[App.jsx]
    C --> D[Navbar / NavbarMobile]
    C --> E[Landing]
    C --> F[About]
    C --> G[Work]
    C --> H[Tech]
    C --> I[Contact]
    C --> J[Footer]
    D -->|Responsive Switch| K{Viewport Size}
    K -->|Desktop| D
    K -->|Mobile| D

    style A fill:#FFD700,color:#000,stroke:#FFD700
    style C fill:#000,color:#FFD700,stroke:#FFD700
    style K fill:#06B6D4,color:#000,stroke:#06B6D4
```
